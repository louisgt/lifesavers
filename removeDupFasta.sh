#!/bin/bash
# Original author of this script: ShaiberAlon
# remove multiple copies of sequences from an input fasta file and saves the result in an output fasta file.
# script based on Pierre Lindenbaum's script: https://www.biostars.org/p/3003/#3008
# input:
# -f | --file  : fasta file
...
# The following pipeline is composed of the following actions:
